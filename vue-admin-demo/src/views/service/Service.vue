<template>
	<section>
		...
		<el-table :data="services" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="server_name" label="服务部署服务器" width="200" sortable>
			</el-table-column>
			<el-table-column prop="port" label="服务端口" width="200" sortable>
			</el-table-column>
...
<script>
	...
	import { getServiceList, createService, modifyService, delService, delServer } from '../../api/api';
