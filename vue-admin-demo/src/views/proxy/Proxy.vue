<template>
  <section>
    ...
    >
      ...
      <el-table-column prop="service_name" label="服务名称" width="150" sortable></el-table-column>
      <el-table-column prop="server_name" label="代理服务器" width="150" sortable></el-table-column>
      <el-table-column prop="proxy_port" label="代理端口" width="150" sortable></el-table-column>
      <el-table-column prop="state" label="状态" width="150" :formatter="formatProxyState" sortable></el-table-column>
      <el-table-column prop="run_state" label="运行状态" width="150" sortable></el-table-column>
  ...
  methods: {
    getProxys() {
      ...
      getProxyList(para).then(res => {
        ...
        this.proxys = res.data.data.results;
