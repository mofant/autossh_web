<template>
	<section>
		...
		<el-table :data="servers" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="服务器名称" width="200" sortable>
			</el-table-column>
			<el-table-column prop="host" label="服务器地址" width="200" sortable>
			</el-table-column>
			<el-table-column prop="server_type" label="服务器类型" width="200" :formatter="formatServerType" sortable>
			</el-table-column>
...
<script>
    ...
    import { getServerList, createServer, modifyServer, delServer } from '../../api/api';
